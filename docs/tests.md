...
**Resultado esperado** | A empresa deve conseguir registrar vagas.
...
**Resultado esperado** | Os usuários devem conseguir interagir no fórum.
...
**Resultado esperado** | As empresas devem conseguir acessar o perfil.
**Dados de entrada** | Clique no atalho "Perfil" da barra de navegação.
**Resultado obtido** | Sucesso.
...
**Resultado esperado** | Os usuários devem conseguir editar o perfil.
...
**Resultado esperado** | O usuário deve poder ser encaminhado para um chat no WhatsApp.
