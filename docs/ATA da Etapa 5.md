Alice: fui responsável por corrigir alguns apontamentos feitos pelo professor durante a apresentação, fiz a avaliação por estrelas funcionais,
...
Luíza: Fui responsável por corrigir a documentação dos casos de testes e testa-los e ajudei a hospedar a aplicação no Vercel com o integrante rafael.
