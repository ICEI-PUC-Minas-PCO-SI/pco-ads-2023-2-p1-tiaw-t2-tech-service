$(document).ready(function () {
  ...
  //Envio pro LocalStorage do formulario do Usuario
  ...
  //Envio do Formulario de Serviços atuais
  $("#input-serv").click(function () {
    ...
    if (novoTitulo == "" || novaDescricao == "") {
      ...
      if (usuario.servicos.length <= 4) {
        ...
        //Mensagem sucesso Serviços
        $("#meuModal-Servico").modal("show");
        $(".modal-title-serv").css("color", "green").text("Sucesso");
        $("#paragraph-modal-serv")
          .css({ color: "green", "font-size": "1.rem" })
          .text("Enviado ");
